...
public static void loggin() throws IOException, JAXBException, SQLException {
        ...
        do {
        	...
        	System.out.println("1 - Iniciar sesi�n como miembro de entreculturas");
        	System.out.println("2 - Iniciar sesi�n como administrador de entreculturas");
        ...
        switch(respuesta) {
           case 1:
              ...
              System.out.println("Introduce tu nombre contrase�a");
