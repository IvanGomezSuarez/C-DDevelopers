...
// atributos
	...
	public Miembros(int idMiembro, java.util.GregorianCalendar fechaAlta,java.util.GregorianCalendar fechaBaja, String nombreMiembro, String apellido1, String apellido2,
			 String dni, String pais, String ciudad, String direccion, String rol, String telefono, String mail) {
		super();
		...
		this.mail = mail; //falta crear los get y set de telefono y mail
	}
